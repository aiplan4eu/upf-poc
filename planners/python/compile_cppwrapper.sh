...
g++ -O3 -shared -fPIC -Wall -Werror -std=c++17 -I${DIR}/../../pybind11/include -I/usr/include/python${PYTHON_VERSION} -I${DIR}/../../upf/cpp ${DIR}/pyplanner_upf.cxx ${DIR}/action.o ${DIR}/problem.o -lpython${PYTHON_VERSION} -o ${DIR}/pyplanner_cppupf.so
