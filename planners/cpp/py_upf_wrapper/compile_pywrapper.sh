...
g++ -O3 -Wall -shared -std=c++17 -fPIC -I${DIR}/.. -I${DIR}/../../../pybind11/include ${DIR}/cppwrapper.cxx -I/usr/include/python${PYTHON_VERSION} ${DIR}/planner.o -o ${DIR}/_cppplanner_upf.so
