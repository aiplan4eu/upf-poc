...
g++ -O3 -shared -fPIC -Wall -std=c++17 -I${HOME}/.local/include -I${DIR}/ -I${DIR}/../../../../upf/cpp ${DIR}/jplanner_upf.cxx ${DIR}/JPlannerUPF.grpc.pb.o ${DIR}/JPlannerUPF.pb.o ${DIR}/action.o ${DIR}/problem.o -L${HOME}/.local/lib `pkg-config --libs protobuf grpc++` -lgrpc++_reflection -ldl -o ${DIR}/jplanner_cppupf.so
